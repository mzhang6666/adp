...
func (m *MockOpenSearchAccess) Count(ctx context.Context, query map[string]any, indices []string) ([]byte, int, error) {
	m.ctrl.T.Helper()
...
func (mr *MockOpenSearchAccessMockRecorder) Count(ctx, query, indices any) *gomock.Call {
...
func (mr *MockOpenSearchAccessMockRecorder) CreatePointInTime(ctx, indices, keepAlive any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockOpenSearchAccessMockRecorder) DeletePointInTime(ctx, pitIDs any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockOpenSearchAccessMockRecorder) DeleteScroll(ctx, deleteScroll any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockOpenSearchAccessMockRecorder) LoadIndexShards(ctx, indices any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockOpenSearchAccessMockRecorder) Scroll(ctx, scroll any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockOpenSearchAccess) SearchSubmit(ctx context.Context, query map[string]any, indices []string, scroll time.Duration, preference string, trackTotalHits bool) ([]byte, int, error) {
	m.ctrl.T.Helper()
...
func (mr *MockOpenSearchAccessMockRecorder) SearchSubmit(ctx, query, indices, scroll, preference, trackTotalHits any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockOpenSearchAccessMockRecorder) SearchSubmitWithBuffer(ctx, query, indices, scroll, preference any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockOpenSearchAccessMockRecorder) SearchWithPit(ctx, query any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
