...
//
//	mockgen -source ../interfaces/mq_access.go -destination ../interfaces/mock/mock_mq_access.go
//
...
func (mr *MockMQAccessMockRecorder) DoCommit(c any) *gomock.Call {
...
func (mr *MockMQAccessMockRecorder) DoConsume(c any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockMQAccessMockRecorder) DoProduceAndCommit(kp, c, msgs any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockMQAccessMockRecorder) NewConsumer(groupID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockMQAccessMockRecorder) NewTransactionalProducer(txId any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
